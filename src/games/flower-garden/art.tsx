import { FLOWER_COLORS, LEAF_COLOR, SOIL_COLOR, STEM_COLOR, type FlowerKey } from './data'
...
export function FlowerArt({ id }: { id: string }) {
  ...
  return (
    <svg viewBox="0 0 120 110" className="h-full w-full" role="img" aria-label="Blume">
      ...
      <ellipse cx="44" cy="64" rx="12" ry="6.5" fill={LEAF_COLOR} transform="rotate(-28 44 64)" />
      <ellipse cx="76" cy="76" rx="12" ry="6.5" fill={LEAF_COLOR} transform="rotate(28 76 76)" />
